...
class FSmithUEBpCompiler
{
public:
	static FSmithUECompileResult CompileFunction(UBlueprint* Blueprint, const FString& Code);
	static bool ValidateSyntax(const FString& Code, FString& OutError);

private:
	FSmithUEBpCompiler(UBlueprint* InBlueprint, UEdGraph* InGraph);
