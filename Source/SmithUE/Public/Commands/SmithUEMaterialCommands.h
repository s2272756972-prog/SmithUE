...
private:
    ...
    static TSharedPtr<FJsonObject> HandleDisconnectMaterialPins(const TSharedPtr<FJsonObject>& Params);
    static TSharedPtr<FJsonObject> HandleRemoveMaterialExpression(const TSharedPtr<FJsonObject>& Params);
