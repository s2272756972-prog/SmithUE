...
void FSmithUESettingsCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	...
	[
		...
		[
			...
			[
				SNew(SHyperlink)
				.Text(FText::FromString(TEXT("GitHub UE5.5 Branch")))
				.ToolTipText(FText::FromString(TEXT("Open the maintained SmithUE UE5.5 compatibility branch")))
				.OnNavigate_Lambda([](){
					FPlatformProcess::LaunchURL(
						TEXT("https://github.com/s2272756972-prog/SmithUE/tree/UE5.5"),
						nullptr, nullptr);
				})
			]
		]
