...
// UEAgent Interaction Command Automation Tests
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_ListEditorCommandsNonEmpty,
    "UEAgent.InteractionCommands.ListEditorCommands_ReturnsNonEmpty",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_ListEditorCommandsNonEmpty::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_ExecuteConsoleCommand,
    "UEAgent.InteractionCommands.ExecuteConsoleCommand_Succeeds",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_ExecuteConsoleCommand::RunTest(const FString& Parameters)
{
    using namespace UEAgentTestUtils;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_GetEditorStateHasFields,
    "UEAgent.InteractionCommands.GetEditorState_HasRequiredFields",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_GetEditorStateHasFields::RunTest(const FString& Parameters)
{
    using namespace UEAgentTestUtils;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_GetActorPropertyInvalidActor,
    "UEAgent.InteractionCommands.GetActorProperty_InvalidActor_ReturnsError",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_GetActorPropertyInvalidActor::RunTest(const FString& Parameters)
{
    using namespace UEAgentTestUtils;
    TSharedPtr<FJsonObject> Params = MakeShared<FJsonObject>();
    Params->SetStringField(TEXT("actor_label"), TEXT("UEAgentNonExistentActor_XYZ_99999"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_ListPanelsHasKnownPanels,
    "UEAgent.InteractionCommands.ListPanels_HasKnownPanels",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_ListPanelsHasKnownPanels::RunTest(const FString& Parameters)
{
    using namespace UEAgentTestUtils;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_SimulateKeyInvalidKey,
    "UEAgent.InteractionCommands.SimulateKey_InvalidKey_ReturnsError",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_SimulateKeyInvalidKey::RunTest(const FString& Parameters)
{
    using namespace UEAgentTestUtils;
    TSharedPtr<FJsonObject> Params = MakeShared<FJsonObject>();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_GetSelectedActorsReturnsArray,
    "UEAgent.InteractionCommands.GetSelectedActors_ReturnsArray",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_GetSelectedActorsReturnsArray::RunTest(const FString& Parameters)
{
    using namespace UEAgentTestUtils;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUEAgentInteraction_ListKeyBindingsNonEmpty,
    "UEAgent.InteractionCommands.ListKeyBindings_ReturnsNonEmpty",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FUEAgentInteraction_ListKeyBindingsNonEmpty::RunTest(const FString& Parameters)
{
    using namespace UEAgentTestUtils;
