...
void FUEAgentViewportCommands::RegisterTools(FUEAgentToolRegistry& Registry)
{
    // set_viewport_camera
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("location"), TEXT("object"), TEXT("Camera location {x,y,z}")),
                FUEAgentToolParam(TEXT("rotation"), TEXT("object"), TEXT("Camera rotation {pitch,yaw,roll}")),
                FUEAgentToolParam(TEXT("fov"),      TEXT("number"), TEXT("Field of view in degrees"))
            }),
    ...
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("actor_label"), TEXT("string"), TEXT("Actor label or name"), true)
            }),
        &HandleFocusOnActor);
    ...
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("mode"), TEXT("string"),
    ...
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("actor_labels"),    TEXT("array"), TEXT("Array of actor labels to select"), true),
                FUEAgentToolParam(TEXT("add_to_selection"), TEXT("boolean"), TEXT("If true, add to current selection; otherwise replace it"))
            }),
        &HandleSelectActors);
}
...
TSharedPtr<FJsonObject> FUEAgentViewportCommands::HandleSetViewportCamera(const TSharedPtr<FJsonObject>& Params)
{
    ...
    UE_LOG(LogUEAgent, Log, TEXT("set_viewport_camera: camera updated"));
...
TSharedPtr<FJsonObject> FUEAgentViewportCommands::HandleFocusOnActor(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE())
    {
        return UEAgentEditorState::CreatePIEErrorResponse();
    ...
    UE_LOG(LogUEAgent, Log, TEXT("focus_on_actor: focused on '%s'"), *ActorLabel);
...
TSharedPtr<FJsonObject> FUEAgentViewportCommands::HandleSetViewportMode(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE())
    {
        return UEAgentEditorState::CreatePIEErrorResponse();
    ...
    {
        return FUEAgentCommonUtils::CreateErrorResponse(TEXT("Missing required param: 'mode'"));
    }
    ...
    UE_LOG(LogUEAgent, Log, TEXT("set_viewport_mode: %s -> %s"), *BeforeMode, *ModeStr);
...
TSharedPtr<FJsonObject> FUEAgentViewportCommands::HandleGetViewportInfoDetailed(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE())
    {
        return UEAgentEditorState::CreatePIEErrorResponse();
...
TSharedPtr<FJsonObject> FUEAgentViewportCommands::HandleSelectActors(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE())
    {
        return UEAgentEditorState::CreatePIEErrorResponse();
    ...
    {
        return FUEAgentCommonUtils::CreateErrorResponse(TEXT("Missing required param: 'actor_labels' (non-empty array)"));
    }

    bool bAddToSelection = false;
    Params->TryGetBoolField(TEXT("add_to_selection"), bAddToSelection);

    const FScopedTransaction Transaction(FText::FromString(TEXT("UEAgent: Select Actors")));
    ...
    UE_LOG(LogUEAgent, Log, TEXT("select_actors: selected %d, not found %d"),
