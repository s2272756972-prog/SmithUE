...
void FUEAgentInteractionCommands::RegisterTools(FUEAgentToolRegistry& Registry)
{
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("command_name"), TEXT("string"), TEXT("Editor command name to execute (e.g. ACTOR SELECT ALL)"), true)
            }),
    ...
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("command"), TEXT("string"), TEXT("Console command string to execute (e.g. r.ScreenPercentage 100)"), true)
            }),
    ...
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("filter"), TEXT("string"), TEXT("Optional case-insensitive substring filter applied to command name or label"))
            }),
    ...
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("key"), TEXT("string"), TEXT("Key name: A-Z, F1-F12, Delete, Enter, Escape, Tab, Space, LeftArrow, RightArrow, UpArrow, DownArrow, Home, End, PageUp, PageDown, Num0-Num9"), true),
                FUEAgentToolParam(TEXT("modifiers"), TEXT("object"), TEXT("Optional modifiers: {ctrl,shift,alt,cmd} booleans"))
            }),
        &HandleSimulateKey);
    ...
    Registry.Register(
        FUEAgentToolSchema(
            ...
            {
                FUEAgentToolParam(TEXT("filter"), TEXT("string"), TEXT("Optional substring filter on command name or label")),
                FUEAgentToolParam(TEXT("context"), TEXT("string"), TEXT("Optional binding context filter (e.g. LevelEditor)"))
            }),
        &HandleListKeyBindings);
}

// execute_editor_command
TSharedPtr<FJsonObject> FUEAgentInteractionCommands::HandleExecuteEditorCommand(const TSharedPtr<FJsonObject>& Params)
{
    ...
    {
        return FUEAgentCommonUtils::CreateErrorResponse(TEXT("Missing required parameter: 'command_name'"));
    }
...
TSharedPtr<FJsonObject> FUEAgentInteractionCommands::HandleExecuteConsoleCommand(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE())
    {
        return UEAgentEditorState::CreatePIEErrorResponse();
    ...
    {
        return FUEAgentCommonUtils::CreateErrorResponse(TEXT("Missing required parameter: 'command'"));
    }
...
TSharedPtr<FJsonObject> FUEAgentInteractionCommands::HandleListEditorCommands(const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FUEAgentInteractionCommands::HandleUndo(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE())
    {
        return UEAgentEditorState::CreatePIEErrorResponse();
...
TSharedPtr<FJsonObject> FUEAgentInteractionCommands::HandleRedo(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE())
    {
        return UEAgentEditorState::CreatePIEErrorResponse();
...
TSharedPtr<FJsonObject> FUEAgentInteractionCommands::HandleSimulateKey(const TSharedPtr<FJsonObject>& Params)
{
    if (UEAgentEditorState::IsInPIE()) return UEAgentEditorState::CreatePIEErrorResponse();
    FString KeyName;
    if (!Params.IsValid() || !Params->TryGetStringField(TEXT("key"), KeyName) || KeyName.IsEmpty())
    {
        return FUEAgentCommonUtils::CreateErrorResponse(TEXT("Missing required parameter: 'key'"));
    }

    FKey Key;
    if (!TryResolveKey(KeyName, Key))
    {
        return FUEAgentCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Unsupported key: %s"), *KeyName));
    }
    ...
    {
        return FUEAgentCommonUtils::CreateErrorResponse(TEXT("FSlateApplication is not initialized"));
    }
...
TSharedPtr<FJsonObject> FUEAgentInteractionCommands::HandleListKeyBindings(const TSharedPtr<FJsonObject>& Params)
{
