...
> `UE5.1` compatibility branch: adapted from SmithUE v1.15.0 and verified with Unreal Engine 5.1 BuildPlugin.
...
1. Clone into `{YourProject}/Plugins/` on branch `UE5.1`:
   ```bash
   cd {YourProject}/Plugins
   git clone -b UE5.1 https://github.com/s2272756972-prog/SmithUE.git
   ```

2. Build your project with Unreal Engine 5.1.
...
- **Engine version**: this branch targets UE 5.1; use the `UE5.5` branch for UE5.5 and validate other versions separately.
